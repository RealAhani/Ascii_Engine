...
///TODO 
/// 1. (PROBLEM) BUFFER HAS AN ARRAY OF SPRITE => SHOUT ADD SPRITE JUST ONE TIME IF ITS EMPTY (CURRENT STATE IS ADD AND REMOVE EVERY FRAME)
/// 1. (SOLUTION) SPRITE ADD IN INIT_WORLD METHOS THEN UPDATE THEIR STATE IN TICK (LOOP)=>NEED OBSERVER PATTERN
/// 1. ADD ONLY COLOR SPRITE OR CHOSING OPTION FOR CREATE ASCII AND PIXLE (COLOR ONLY) WITH HIGHER RESOLUTION ===>CHANGING LOAD CHAR_INFO PTR WITH 
